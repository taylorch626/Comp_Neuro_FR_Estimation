...
Nex = 100; % number of training examples to generate
...
%     strains{i} = strains{i}/1000; % convert spike times to s
    strains{i} = strains{1}; % sanity check to see if error is minimized if using same example
end

%% Train perceptron

ep  = 1; % learning rate
Nst = 2; % number of spike trains to average
